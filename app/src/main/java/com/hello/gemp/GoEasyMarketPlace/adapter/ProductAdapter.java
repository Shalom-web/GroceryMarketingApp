package com.hello.gemp.GoEasyMarketPlace.adapter;
...
import com.hello.gemp.GoEasyMarketPlace.activity.BaseActivity;
import com.hello.gemp.GoEasyMarketPlace.activity.ProductActivity;
import com.hello.gemp.GoEasyMarketPlace.activity.ProductViewActivity;
import com.hello.gemp.GoEasyMarketPlace.interfaces.AddorRemoveCallbacks;
import com.hello.gemp.GoEasyMarketPlace.model.Cart;
        ...
        if (!cartList.isEmpty()) {
            for (int i = 0; i < cartList.size(); i++) {
                if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                    ...
                    holder.subTotal.setText(_quantity + "X" + _price + "= XAF." + _subtotal);
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                            ...
                            holder.subTotal.setText(total_item + "X" + holder.price.getText().toString() + "= XAF." + _subtotal);
