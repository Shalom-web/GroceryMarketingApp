...
import com.hello.gemp.GoEasyMarketPlace.activity.CartActivity;
import com.hello.gemp.GoEasyMarketPlace.activity.MainActivity;
import com.hello.gemp.GoEasyMarketPlace.adapter.CheckoutCartAdapter;
import com.hello.gemp.GoEasyMarketPlace.model.Cart;
import com.hello.gemp.GoEasyMarketPlace.model.Order;
...
public class ConfirmFragment extends Fragment {
    ...
    private void closeProgress() {
        ...
        Order order = new Order(id, orderNo, currentDateandTime, "XAF. " + _totalAmount, "Pending");
        orderList.add(order);
